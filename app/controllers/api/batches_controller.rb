class Api::BatchesController < ApplicationController
    ...
    private
    def batch_params
        params.require(:batch).permit(:sale_start_time, :sale_end_time, :visibility, :absorb_fees, :quantity, :price, :min_num_tickets_sold, :max_num_tickets_sold, :sales_channel)
    end
